...
- [x] 结构化 Tick 保留 365 天（可配置），不再重复保存原始 JSON
...
MANUAL_EXECUTION_PERMIT_ENABLED=false
MANUAL_EXECUTION_PERMIT_TRUSTED_PUBLIC_KEYS_JSON={}
MANUAL_EXECUTION_PERMIT_ACCOUNT_HASHES=
MANUAL_EXECUTION_PERMIT_CONSUME_ROOT=logs/manual-execution-permit/consumed
MANUAL_EXECUTION_PERMIT_MAX_TTL_SECONDS=300
