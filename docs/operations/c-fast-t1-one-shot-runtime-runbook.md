...
continuity、health、backlog 和 rollback 仍属于独立 L3 变更。其离线授权契约见
[`commodity-c-fast-readonly-deployment-release.md`](../commodity-c-fast-readonly-deployment-release.md)；
该契约本身同样不执行部署或查询。
