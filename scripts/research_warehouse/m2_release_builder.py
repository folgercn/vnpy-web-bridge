...
def _bootstrap(role: str) -> bytes:
    modules = {
        ...
        "linked-publisher": "research_warehouse.m2_linked_predecessor_cli",
        "experimental-timely-route": "simnow_experimental_timely_daily_route",
    ...
    *,
    ...
    try:
        ...
        roles = {
            ...
            "linked-publisher": "research-warehouse-linked-publisher",
            "experimental-timely-route": "research-warehouse-experimental-timely-route",
