...
def test_remote_mutation_timeout_is_explicit_unknown_outcome() -> None:
    ...
    client = RemotePhaseCWorkflowClient(PhaseCRemoteSettings("http://custody", "http://execution", "c", "e"), transport=httpx.MockTransport(handler))
    payload = SignedArtifactUploadDTO(idempotency_key="custody-key-0001", expected_custody_version=0, signing_request_id="request-0001", correlation_id="correlation-0001", signed_artifact={})
